...
-- ('example', 'linkedIn', 'Cleber Albuquerque - LinkedIn', 'https://www.linkedin.com/in/cleberlop/' ),
-- ('example', 'linkedIn', 'Brett Caudill - LinkedIn', 'https://www.linkedin.com/in/brettcaudill/' ),
-- ('example', 'linkedIn', 'Wyatt Johnny - LinkedIn', 'https://www.linkedin.com/in/wyattjohnny/' ),
-- ('example', 'linkedIn', 'Jeff Chapman - LinkedIn', 'https://www.linkedin.com/in/chapmanjeffrey/' ),
-- ('example', 'portfolio', 'Matt Guenther - Portfolio', 'http://mattguenther.com/'),
-- ('example', 'portfolio', 'Rebecca Lynn Bossart - Portfolio', 'http://www.rebeccalynnbossart.com/'),
-- ('example', 'portfolio', 'Parker Donat - Portfolio', 'http://parkerdonat.com/'),
-- ('example', 'portfolio', 'Mike Harvey - Portfolio', 'http://mikeharvey.me/'),
-- ('example', 'portfolio', 'Robby Leonardi - Portfolio', 'http://www.rleonardi.com/interactive-resume/'),
-- ('example', 'portfolio', 'Marcus Brown - Portfolio', 'https://remote.com/marcusbrown?ref=brandedme'),
-- ('example', 'portfolio', 'Dylan Slade - Portfolio', 'http://dylanslade.com/#ios-developer'),
-- ('example', 'portfolio', 'Mike Curtis - Portfolio', 'https://mikewcurtis.com/'),
-- ('example', 'portfolio', 'Jeff Chapman - Portfolio', 'https://chapmanjeff.github.io/portfolio/'),
-- ('job websites', 'linkedin', 'LinkedIn Jobs', 'https://www.linkedin.com/jobs/'),
-- ('job websites', 'hired.com', 'Hired', 'https://hired.com/x/vhEmbv'),
-- ('job websites', 'angel.co', 'Angel', 'https://angel.co/'),
-- ('job websites', 'dice.com', 'Dice', 'http://www.dice.com/'),
-- ('job websites', 'indeed.com', 'Indeed', 'https://www.indeed.com/'),
-- ('job websites', 'glassdoor.com', 'Glassdoor', 'https://www.glassdoor.com/index.htm'),
-- ('job websites', 'monster.com', 'Monster', 'https://www.monster.com/'),
-- ('job websites', 'jrdevjobs.com', 'Jr.DevJobs', 'https://www.jrdevjobs.com/'),
-- ('job websites', 'siliconslopes.com', 'Silicon Slopes', 'https://siliconslopes.com/'),
-- ('job websites', 'careerbuilder.com', 'Career Builder', 'http://www.careerbuilder.com/?cbrecursioncnt=1'),
-- ('job websites', 'craigslist.com', 'CraigsList', 'https://www.craigslist.org/about/sites#US'),
-- ('job websites', 'swiftjobs.com', 'Swift Jobs', 'http://www.swift-jobs.com/'),
-- ('bootcamp grads', 'lanchcode', 'Launch Code', 'https://www.launchcode.org/apply'),
-- ('bootcamp grads', 'bootcampxchange', 'BootcampXchange', 'http://www.bootcampxchange.com/'),
-- ('freelance gigs', 'upwork', 'UpWork', 'https://www.upwork.com/'),
-- ('freelance gigs', 'guru', 'Guru', 'https://www.guru.com/'),
-- ('freelance gigs', 'weworkremotely', 'WeWorkRemotely', 'https://weworkremotely.com/'),
-- ('freelance gigs', 'hyrjobs', 'HYR Fluid Jobs', 'http://www.hyrjobs.com/'),
-- ('freelance gigs', 'linkedin', 'In Profinder', 'https://www.linkedin.com/profinder'),
-- ('freelance gigs', 'remotive', 'Remotive', 'https://remotive.io/'),
-- ('freelance gigs', 'flexjobs', 'Flex Jobs', 'https://www.flexjobs.com/'),
-- ('freelance gigs', 'remoteok', 'Remote Ok', 'https://remoteok.io/'),
-- ('freelance gigs', 'powertofly',' Power To Fly', 'https://powertofly.com/');
